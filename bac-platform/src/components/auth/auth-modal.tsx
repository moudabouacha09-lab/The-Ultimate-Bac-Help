...
import { X, Mail, Lock, User, Sparkles, LogIn, UserPlus, CheckCircle2, GraduationCap } from "lucide-react";
...
export function AuthModal() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    setIsSubmitting(true);
    try {
      // Fast simulation of Google OAuth Sign-In for Replit
      const mockGoogleEmail = `user_${Math.floor(1000 + Math.random() * 9000)}@gmail.com`;
      const res = await register({
        username: "طالب البكالوريا ✨",
