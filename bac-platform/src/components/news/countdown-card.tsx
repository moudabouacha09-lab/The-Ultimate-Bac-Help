...
export function CountdownCard() {
  ...
  return (
    <div className="bg-surface-bright border border-primary/10 rounded-xl p-6 md:p-8 inline-block shadow-sm">
      ...
      <div className="flex gap-4 md:gap-8 justify-center text-center rtl:flex-row-reverse" aria-live="polite">
        <div className="flex flex-col">
          <span className="font-headline text-headline-lg text-primary font-bold bg-surface-container-low border border-primary/10 rounded-lg w-16 h-16 md:w-20 md:h-20 flex items-center justify-center shadow-sm">
            {values.days}
          </span>
