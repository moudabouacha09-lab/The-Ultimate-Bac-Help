...
import { Sprout, Dna, Zap } from "lucide-react";
  ...
  return (
    <AppShell>
      ...
      <div style={{
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", fontWeight: "800", fontSize: "1.1rem", color: "var(--text-primary)", marginBottom: "0.25rem" }}>
            <span>⏱️ اختبار تشخيص المكتسبات التفاعلي</span>
          </div>
          <p style={{ margin: 0, color: "var(--text-secondary)", fontSize: "0.9rem" }}>
            اختبر معلوماتك السابقة في الرياضيات، الفيزياء، والعلوم مع تصحيح فوري وتمرين شامل محلول.
          </p>
        </div>
        <Link
        ...
        <FadeInSection delay={0}>
          <section className="prerequisite-section">
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1rem', marginBottom: '1rem' }}>
              ...
              <a href="https://youtu.be/pWJsnK4TGiY" target="_blank" rel="noopener noreferrer" style={{ backgroundColor: 'var(--red-600)', color: 'var(--text-on-blue)', padding: '0.5rem 1rem', borderRadius: '8px', textDecoration: 'none', fontSize: '0.9rem', fontWeight: 500, whiteSpace: 'nowrap' }}>
                الأفضل المشاهدة من اليوتيوب ↗
              </a>
            </div>
            <div className="video-wrapper" style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden', borderRadius: '12px', boxShadow: 'var(--shadow-sm)' }}>
              <iframe 
        ...
        <FadeInSection delay={80}>
          <section className="prerequisite-section">
            <h2 style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '1.5rem', marginBottom: '1rem', color: 'var(--green-600)' }}>
              <span className="subject-icon subject-icon-green" style={{ width: '2rem', height: '2rem', fontSize: '1rem', display: 'grid', placeItems: 'center' }}><Dna size={20} /></span>
              العلوم الطبيعية
            </h2>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1rem', marginBottom: '1rem' }}>
              <p style={{ color: 'var(--text-muted)', lineHeight: '1.6', flex: '1 1 300px' }}>
              ...
              <a href="https://youtu.be/EPv7qV4ryX8" target="_blank" rel="noopener noreferrer" style={{ backgroundColor: 'var(--red-600)', color: 'var(--text-on-blue)', padding: '0.5rem 1rem', borderRadius: '8px', textDecoration: 'none', fontSize: '0.9rem', fontWeight: 500, whiteSpace: 'nowrap' }}>
                الأفضل المشاهدة من اليوتيوب ↗
              </a>
            </div>
            <div className="video-wrapper" style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden', borderRadius: '12px', boxShadow: 'var(--shadow-sm)', marginBottom: '2rem' }}>
              <iframe 
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
              <div>
                <div style={{ marginBottom: '0.5rem', textAlign: 'left' }}>
                  <a href="https://youtu.be/X0yKn_MP-fM" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', backgroundColor: 'var(--red-600)', color: 'var(--text-on-blue)', padding: '0.4rem 0.8rem', borderRadius: '6px', textDecoration: 'none', fontSize: '0.8rem', fontWeight: 500 }}>
                    شاهد في اليوتيوب ↗
                  </a>
                </div>
                <div className="video-wrapper" style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden', borderRadius: '12px', boxShadow: 'var(--shadow-sm)' }}>
              ...
              <div>
                <div style={{ marginBottom: '0.5rem', textAlign: 'left' }}>
                  <a href="https://youtu.be/MG_EbEpMQoY" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', backgroundColor: 'var(--red-600)', color: 'var(--text-on-blue)', padding: '0.4rem 0.8rem', borderRadius: '6px', textDecoration: 'none', fontSize: '0.8rem', fontWeight: 500 }}>
                    شاهد في اليوتيوب ↗
                  </a>
                </div>
                <div className="video-wrapper" style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden', borderRadius: '12px', boxShadow: 'var(--shadow-sm)' }}>
        ...
        <FadeInSection delay={160}>
          <section className="prerequisite-section">
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1rem', marginBottom: '1rem' }}>
              ...
              <a href="https://www.youtube.com/playlist?list=PLlkvPioEFgAILdlft6aIzWjrjreH0RBY3" target="_blank" rel="noopener noreferrer" style={{ backgroundColor: 'var(--red-600)', color: 'var(--text-on-blue)', padding: '0.5rem 1rem', borderRadius: '8px', textDecoration: 'none', fontSize: '0.9rem', fontWeight: 500, whiteSpace: 'nowrap' }}>
                الأفضل المشاهدة من اليوتيوب ↗
              </a>
            </div>
            <div className="video-wrapper" style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden', borderRadius: '12px', boxShadow: 'var(--shadow-sm)' }}>
